...
class MainViewController: UIViewController {
    ...
    var controller : UserDetailsController?
    
    override func viewDidLoad() {
        super.viewDidLoad()
        // Do any additional setup after loading the view.
        userViewModelInstance.fetchUserList()
        controller = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "UserDetailsController") as! UserDetailsController
    }
    ...
    func bindUI() {
        ...
        tableview.rx.itemSelected.subscribe(onNext: { (indexPath) in
            ...
            self.navigationController?.pushViewController(self.controller ?? UserDetailsController(), animated: true) }).disposed(by: bag)
